...
const JoinNow = () => {
    ...
    return (
        <div className="font-averta bg-black h-screen flex flex-col text-whyte">
            <main className="grow flex justify-center items-center">
                <div className="mt-[-8rem] lg:w-1/5 md:w-1/2 flex flex-col gap-8 justify-center items-start">
                    ...
                    <div className="flex flex-col w-full p-8 gap-4 bg-darkGrhey rounded-lg drop-shadow-md">
                        ...
                        } : undefined)} stretch size="large" image="/goog.png">Continue with Google</Button>
                    </div>
                </div>
